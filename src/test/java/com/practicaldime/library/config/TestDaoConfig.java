package com.practicaldime.library.config;
...
@PropertySource("test-jdbc.properties")
@ComponentScan({"com.practicaldime.library.dao"})
public class TestDaoConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "com.practicaldime.library.entity" });
